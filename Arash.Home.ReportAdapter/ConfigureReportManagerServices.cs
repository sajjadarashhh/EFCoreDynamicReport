...
namespace Arash.Home.ReportAdapter
{
    ...
    {
        public static IServiceCollection ConfigureReportManager(this IServiceCollection services, Func<ReportExecuteQueryRequest, Task<ReportExecuteQueryResponse>> executeQueryCustom = null)
        {
            ...
            {
                return new ReportAdapterService(t.GetRequiredService<IQueryGeneratorService>(), t.GetRequiredService<IExcelGenerator>(), t.GetRequiredService<DbContext>(), executeQueryCustom);
            });
            return services;
        }
    }
